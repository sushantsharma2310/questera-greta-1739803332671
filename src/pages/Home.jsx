      ...
      <section id="featured" className="py-16 bg-amber-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Coffee" className="w-full h-48 object-cover" />
              <div className="p-6">
            ...
            <motion.div 
              ...
              className="bg-white rounded-lg shadow-lg overflow-hidden"
            >
              <img src="https://images.unsplash.com/photo-1514517220017-8ce97a34a7b6?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Pastry" className="w-full h-48 object-cover" />
              <div className="p-6">
            ...
            <motion.div 
              ...
              className="bg-white rounded-lg shadow-lg overflow-hidden"
            >
              <img src="https://images.unsplash.com/photo-1541167760496-1628856ab772?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" alt="Breakfast" className="w-full h-48 object-cover" />
              <div className="p-6">
